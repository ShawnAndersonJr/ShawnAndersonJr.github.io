(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 600, 70, 6, 0.7);
        collectable.create(type.grace, 200, 170, 6, 1.7);
        collectable.create(type.steve, 800, 20, 6, 0.7);
      
        collectable.create(type.max, 450, 170, 6, 0.999);
